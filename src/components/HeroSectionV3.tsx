      ...
      <div className="max-w-7xl mx-auto px-4" style={{ paddingTop: "40px" }}>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            Deliver Zero-Defect Digital Experiences—Powered by Mozark’s AI Observability Platform
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
Mozark replicates real user journeys across mobile, web, TV, and cloud—without SDKs or backend access. Our AI-driven platform proactively detects performance risks, ensuring flawless customer experiences from launch to scale.
            </p>
