// src/components/Calculators/DetailedROIAnalysisModal.tsx
'use client';

import { useState } from 'react';
import Modal from '../ui/Modal'; // Make sure this path is correct too!
...
export default function DetailedAnalysisModal({
  ...
  // Safe check for impactMetrics
  const safeImpactMetrics = impactMetrics || [];
      ...
      <div className="space-y-6">
        {formSubmitted ? (
          <>
            ...
            {safeImpactMetrics.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {safeImpactMetrics.map((metric, index) => (
                  <div
                    key={index}
          ...
          <>
            {safeImpactMetrics.length > 0 && (
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 mb-3">Your ROI Analysis Preview</h4>
                <div className="grid grid-cols-2 gap-3">
                  {safeImpactMetrics.slice(0, 4).map((metric, index) => (
