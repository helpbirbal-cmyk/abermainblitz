      ...
      <div className="max-w-7xl mx-auto px-4" style={{ paddingTop: "40px" }}>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            Unrivaled Digital Performance, Engineered by AI
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
            We use AI to continuously monitor and test your digital products, proactively eliminating performance risks and ensuring a flawless, reliable experience for your customers from launch to beyond
            </p>
